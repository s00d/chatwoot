<template>
  <div
    ...
    :class="{
      'animate-card-select bg-slate-25 dark:bg-slate-800 border-woot-500 active':
        isActiveChat,
  ...
  >
    ...
    />
    <div
      class="px-0 py-1 border-b group-last:border-transparent group-hover:border-transparent border-slate-50 dark:border-slate-800/75 w-[calc(100%-40px)] columns"
    >
      ...
      <div class="absolute flex flex-col conversation--meta right-4 top-4">
        ...
        <span
          class="unread shadow-lg rounded-full hidden text-xxs font-semibold h-4 leading-4 ml-auto mt-1 min-w-[1rem] px-1 py-0 text-center text-white bg-red-400"
        >
